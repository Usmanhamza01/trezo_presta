// ================================================================
// TREZO SERVICES — Configuration
// Pré-rempli pour l'espace de la cliente. Ne pas modifier sauf
// changement de projet Supabase.
//
// edition       : 'services' (cette app gère prestations, devis, projets…)
// urlCommerce/urlServices : bascule BUSINESS (un compte, deux espaces, SSO)
// ================================================================
window.TREZO_CONFIG = {
